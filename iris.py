...
Original file is located at
    https://colab.research.google.com/drive/1THZYotPNvIB0QUsVbygfL1vrWZDrXRpE
"""
...
tuner=kt.Hyperband(build_model,
                          ...
                          max_epochs=5,directory='outp1',project_name="Auto-AF")
...
history =model.fit(X_train,y_train,epochs=25, validation_split=0.3, initial_epoch=3)
...
f1score = f1_score(y_test, test_pred_labels, average=None)
f1score